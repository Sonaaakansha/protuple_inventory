...
class categoryClass:
    def __init__(self, root):
        ...
        lbl_name = Label(self.root, text="Enter Category Name", font=("goudy old style", 30), bg="white").place(x=50,
                                                                                                                y=100)
        txt_name = Entry(self.root, textvariable=self.var_name, font=("goudy old style", 18), bg="lightyellow").place(
        ...
        btn_add = Button(self.root, text="ADD", command=self.add, font=("goudy old style", 15), bg="#4caf50",
        ...
        self.cateory_table = ttk.Treeview(cat_frame, columns=("cid", "name"), yscrollcommand=scrolly.set,
        ...
        self.im2 = Image.open("C:\\Users\\Dell\\.vscode\\protuple_inventory\\warehouse-management-software.png")
